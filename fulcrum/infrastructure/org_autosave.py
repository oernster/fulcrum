...
level. Writes are atomic; a missing or unreadable file means nothing to
restore and an unreadable history degrades to the org alone.
"""
...
class FileOrgStore:
    ...
    def save(self, snapshot: SessionSnapshot) -> None:
        """Write the session atomically to the autosave path."""
